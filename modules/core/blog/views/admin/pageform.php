<form method="post" enctype="multipart/form-data" class="col-md-12 nopadding" action="<?php echo mainframe::__adminBuildUrl('blog/save'); ?>">
    <div class="page-header">
        <div class="page-title">
            <h3><?php echo intval($this->pageId) ? 'Edit' : 'Add New'; ?> <?php echo $this->__aT('Post'); ?></h3>
        </div>
        <div class="pull-right">
            <h3>
                <button type="button" onclick="window.location = '<?php echo mainframe::__adminBuildUrl('blog'); ?>';" value="new" name="exit" class="btn btn-warning"><i class="icon-angle-left"></i> <?php echo $this->__aT('Back'); ?></button>
        ...
        <div class="tab-content" style="padding-top:20px;">
            <div class="tab-pane active" id="1">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label><?php echo $this->__aT('Post Image'); ?></label>
                        <input type="file" data-style="fileinput" name="db_image">
                        <?php if(!empty($this->postedData['image'])) {?>
                            <img src="<?php echo SITE_URL.SITE_UPLOADPATH.$this->postedData['image'];?>" width="100" height="100">
                        <?php } ?>
                    </div>
                    <div class="form-group">
           ...
           <input type="hidden" name="md_status" value="1">
        </div>
</form>
 <script>
    CKEDITOR.replace( 'md_content' );
</script>